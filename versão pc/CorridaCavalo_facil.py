...
def main():
    ...
    def distribuir_e_consumir_doses(ordem_chegada, doses_cavalos):
        ...
        if doses_cavalos[segundo_lugar] == 2:
            doses_cavalos[segundo_lugar] = 1

        doses_cavalos[terceiro_lugar] += doses_cavalos[primeiro_lugar]
        doses_cavalos[quarto_lugar] += doses_cavalos[primeiro_lugar] + 1

        doses_cavalos[primeiro_lugar] = 0
